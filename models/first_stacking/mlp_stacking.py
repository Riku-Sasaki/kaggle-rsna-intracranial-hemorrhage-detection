...
def main():
    ...
    with open('../../intermediate_output/agged_feats_for_first_stacking_sugawara/test_stackfeats.pickle', 'rb') as f:
        test_list = pickle.load(f)
    with open('../../intermediate_output/agged_feats_for_first_stacking_sugawara/train_stackfeats.pickle', 'rb') as f:
        train = pickle.load(f)
