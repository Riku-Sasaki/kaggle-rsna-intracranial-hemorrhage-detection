...
if __name__ == '__main__':
    model_list = ['sugawara_efficientnetb3',
    ...
    os.makedirs('../../intermediate_output/agged_feats_for_first_stacking_sugawara')
    with open('../../intermediate_output/agged_feats_for_first_stacking_sugawara/test_stackfeats.pickle', 'wb') as f:
        pickle.dump(test_list, f)
    with open('../../intermediate_output/agged_feats_for_first_stacking_sugawara/train_stackfeats.pickle', 'wb') as f:
        pickle.dump(train, f)
