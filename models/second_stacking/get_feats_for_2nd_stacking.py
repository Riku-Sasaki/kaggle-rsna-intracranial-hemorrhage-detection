...
'stacking1_mlp_for_sugawara_stacking2'
    ...
    os.makedirs('../../intermediate_output/agged_feats_for_second_stacking_sugawara')
    with open('../../intermediate_output/agged_feats_for_second_stacking_sugawara/test_stackfeats.pickle', 'wb') as f:
        pickle.dump(test_list, f)
    with open('../../intermediate_output/agged_feats_for_second_stacking_sugawara/train_stackfeats.pickle', 'wb') as f:
        pickle.dump(train, f)
